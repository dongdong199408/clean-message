...
class BertClassifier:
    ...
    def model_fn_builder(self, bert_config, num_labels, init_checkpoint, learning_rate,
        ...
        def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
            ...
            (total_loss, per_example_loss, logits, probabilities) = BertClassifier.create_model(
    ...
    def get_estimator(self):
        ...
        return Estimator(model_fn=model_fn,
                         config=RunConfig(session_config=config,save_summary_steps=100,
                         save_checkpoints_steps = 100,keep_checkpoint_max = 1),
...
if __name__ == '__main__':
    ...
    while True:
        ...
        predict = sim.predict_one(sentence)
